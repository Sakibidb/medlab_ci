                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        <div class="text-center">
                            <a href="index.html">
                                <img src="<?= site_url('assets/images/logo-dark.png')?>" alt="" height="22" class="mx-auto">
                            </a>
                        ...
                        <div class="card">
                            ...
                            ?>
                                ...
                                <form action=<?=base_url("register/store")?> method="post">
                                    ...
                                    <div class="mb-3">
                                        <label for="password" class="form-label">Password</label>
                                        <input class="form-control" type="password" required id="password" placeholder="Retype password" name="confirmpassword">
                                    </div>
                                    <div class="mb-3">
