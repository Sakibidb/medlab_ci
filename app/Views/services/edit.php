        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?php echo site_url('services/update/'.$id)?>" method="post" enctype="multipart/form-data">
                        <div id="wizard" class="text-center">

                            <section>
                                <div class="form-row"> <input type="text" class="form-control" placeholder="Service Name" name="name" value="<?=$name?>"> </div>
                                <div class="form-row"> <input type="text" class="form-control" placeholder="Price" name="price" value="<?=$price?>"> </div>
                                <div class="form-row"> <input type="text" class="form-control" placeholder="Doctor Name" name="dr" value="<?=$doctor?>"> </div>
                                <div class="form-row"> <input type="number" class="form-control" placeholder="Phone number" name="phn" value="<?= $mobile ?>"> </div>
