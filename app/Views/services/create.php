                ...
                <div class="container-fluid">
                    ...
                    <form action="/services/store" method="post" enctype="multipart/form-data">
                        <div id="wizard" class="text-center">
                            ...
                            <section>
                                <div class="form-row"> <input type="text" class="form-control" placeholder="Service Name" name="name" value="<?= set_value('name') ?>"> </div>
                                <div class="form-row"> <input type="text" class="form-control" placeholder="Price" name="price" value="<?= set_value('price') ?>"> </div>
                                <div class="form-row"> <input type="text" class="form-control" placeholder="Doctor Name" name="dr"> </div>
                                <div class="form-row"> <input type="number" class="form-control" placeholder="Phone number" name="phn" value="<?= set_value('phn') ?>"> </div>
